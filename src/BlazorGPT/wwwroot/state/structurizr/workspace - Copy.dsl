  ...
  model {
    bridgeSystem = softwareSystem "Storm Elevate Bridge" "Schedules exports. Converts data." {
        ...
        functionApp = container "Azure Functions App" "Azure Functions" {
            ...
            StormTriggerProductExportFunction = component "StormTriggerProductExportFunction" "Initiates an export"     
            StormCheckStatusAndDownloadFileFunction = component "StormCheckStatusAndDownloadFileFunction" "Checks export job status and downloads file when ready"
    ...
    StormTriggerProductExportFunction -> stormSystem "Makes HTTP GET requests to trigger exports"
    StormCheckStatusAndDownloadFileFunction -> stormSystem "Makes HTTP GET requests to see if export is ready"
